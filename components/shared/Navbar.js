...
import { useLazyGetUser, useGetMainMenu } from '@/apollo/actions';
      ...
      <Navbar expand="lg" className="navbar-dark fj-mw9">
        ...
        <Navbar.Collapse>
          <Nav className="mr-auto">
            { typeof data !== 'undefined' && data.mainMenus.map(menulink =>
              <AppLink id={Math.random()} href="{menulink.link}" className="nav-link mr-3">
                {menulink.title}
              </AppLink>
            )}
